...
const CartItems: React.FC<{
    setIncrementQuantity: (price: string) => void;
    setDecermentQuantity: (price: string) => void;
    title: string;
    price: string;
    image: string;
}> = (props) => {
    ...
    const handleIncrement: React.MouseEventHandler = () => {
        ...
        props.setIncrementQuantity(props.price);
    };
    ...
    const handleDecrement: React.MouseEventHandler = () => {
        ...
        props.setDecermentQuantity(props.price);
    };
